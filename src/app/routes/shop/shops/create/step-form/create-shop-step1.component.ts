...
@Component({
  selector: 'app-shop-shops-create-step1',
  templateUrl: './create-shop-step1.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class CreateShopStep1Component implements OnInit {
  isVisible = false;
      ...
      buttons: [
        {
          ...
          click: (item: any) => {
            if (item.id){
              this.srv.admin_id = item.id;
              this.srv.admin_name = item.name;
              ++this.item.step;
            }
          }
        },
  ...
  constructor(
    ...
    private srv: ShopCreateTransferService,
