...
export class ScoreScoresComponent implements OnInit {
  ...
  getData(): void {
    let url = environment["apis"]["webBase"] + environment["apis"]["QueryScore"];
    this.loading = true;
  ...
  remove(): void {
    let url = environment["apis"]["webBase"] + environment["apis"]["DeleteScore"];
  ...
  add(tpl: TemplateRef<{}>): void {
    this.modalSrv.create({
      ...
      nzOnOk: () => {
        this.loading = true;
        let url = environment["apis"]["webBase"] + environment["apis"]["CreateScore"];
