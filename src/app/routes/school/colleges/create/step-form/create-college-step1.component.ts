...
@Component({
  selector: 'app-school-college-create-step1',
  templateUrl: './create-college-step1.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class CreateCollegeStep1Component implements OnInit {
  isVisible = false;
  ...
  constructor(
    ...
    private srv: CollegeCreateTransferService,
