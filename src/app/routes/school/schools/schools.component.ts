...
export class SchoolSchoolsComponent implements OnInit {
  ...
  getData(): void {
    let url = environment["apis"]["webBase"] + environment["apis"]["QuerySchool"];
    this.loading = true;
  ...
  remove(): void {
    let url = environment["apis"]["webBase"] + environment["apis"]["DeleteSchool"];
  ...
  add(tpl: TemplateRef<{}>): void {
    this.modalSrv.create({
      ...
      nzOnOk: () => {
        this.loading = true;
        let url = environment["apis"]["webBase"] + environment["apis"]["CreateSchool"];
